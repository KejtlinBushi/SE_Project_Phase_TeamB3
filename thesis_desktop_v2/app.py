...
# donut chart, deadline countdown, grading dialog, etc.)
from pages.milestones import StudentMilestones as _StudentMilestones
...
class StudentApp(BaseApp):
    ...
    PAGES = {
        "dashboard":     StudentDashboard,
        "submissions":   StudentSubmissions,
        "deadlines":     _StudentDeadlines,
        "milestones":    _StudentMilestones,
        "messages":      StudentMessages,
        "meetings":      StudentMeetings,
        "notifications": StudentNotifications,
        "profile":       StudentProfile,
...
class SupervisorApp(BaseApp):
    ...
    PAGES = {
        "dashboard":     SupervisorDashboard,
        "reviews":       SupervisorReviews,
        "deadlines":     _SupervisorDeadlines,
        "milestones":    _SupervisorMilestones,
        "meetings":      SupervisorMeetings,
        "messages":      SupervisorMessages,
        "notifications": SupervisorNotifications,
        "profile":       SupervisorProfile,
