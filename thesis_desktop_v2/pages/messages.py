...
# Option 2 - Modern tab-style messages page.

# Includes:
# - cleaner chat header
# - Chat / Files tabs
# - modern message bubbles
# - modern file attachment cards
# - compact input bar
# - reusable StudentMessages and SupervisorMessages classes
# """
...
#             height=2
#         )
#         avatar.pack(side="left", padx=(18, 12), pady=14)
...
#             cursor="hand2"
#         )
#         attach.pack(side="left", padx=(12, 8))
...
#             highlightthickness=1
#         )
#         entry_holder.pack(side="left", fill="x", expand=True, ipady=2)
...
#             font=("Segoe UI", 10)
#         )
#         self.message_entry.pack(fill="x", padx=10, ipady=8)
...
#             cursor="hand2"
#         )
#         send.pack(side="right", padx=(8, 12))
...
#         if row.get("attachment_path"):
#             self._add_attachment_bubble_content(bubble, row, is_me)
...
#         tk.Label(
#             footer,
#             text=str(row["sent_at"])[11:16] if row.get("sent_at") else "",
#             bg=bubble_bg,
#             fg=MUTED,
#             font=("Segoe UI", 8)
#         ).pack(side="right")
...
#     def _add_attachment_bubble_content(self, parent, row, is_me):
...
#         icon = tk.Label(
#             file_card,
#             text="PDF" if attachment_name.lower().endswith(".pdf") else "DOC",
#             bg="#d93025",
#             fg=WHITE,
#             font=("Segoe UI", 8, "bold"),
#             padx=6,
...
#         # Kept simple because the avatar variable is local in the header.
#         pass
...
class ChatMessagesBase(tk.Frame):
    ...
    def _build_reply_preview(self):
        ...
        left = tk.Frame(self.reply_preview, bg="#f8fafc")
        ...
        self.reply_text.pack(anchor="w", pady=(2, 0))
    ...
    def _start_reply(self, row):
        ...
        self.reply_title.config(
            text=f"Replying to {'You' if row['sender_role'] == self.current_role else self.other_user_name}"
        )
        self.reply_text.config(text=self._message_summary(row))
        self.reply_preview.pack(fill="x", pady=(10, 0), before=self.input_outer)
        self.message_entry.focus_set()

    def _cancel_reply(self):
        self.reply_to_message = None
        self.reply_preview.pack_forget()
